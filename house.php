...
<table class='buystuffs'><tr><td>
	You currently have in inventory:<?php if(!empty($ingesonhand)){foreach($ingsonhand as $ing) echo "<br/>".$ing;}?><br/>
...
<table class='buystuffs'><tr><td>
	You currently have in inventory:<?php if (!empty($ininven)){foreach($ininven as $inv) echo "<br/><a href='' onlick='placeinroom()'>".$inv."</a>";}?><br/></td></tr>
